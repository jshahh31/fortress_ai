  ...
  return (
    <div className="glass-panel rounded-2xl p-8 border-[#1B3A5C]/30">
      ...
      <div className="grid grid-cols-1 gap-3">
        <button className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 rounded-xl py-2.5 text-sm font-medium text-muted-foreground hover:text-secondary hover:bg-white/10 transition-all">
